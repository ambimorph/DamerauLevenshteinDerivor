...
PKG='DamerauLevenshteinDerivor'

import os

import versioneer
versioneer.versionfile_source = os.path.join('src', 'Python', 'DamerauLevenshteinDerivor', '_version.py')
versioneer.versionfile_build = os.path.join('DamerauLevenshteinDerivor', '_version.py')
